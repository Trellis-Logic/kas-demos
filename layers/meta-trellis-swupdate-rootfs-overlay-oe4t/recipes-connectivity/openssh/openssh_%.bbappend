...
do_install:append() {
    ...
    install ${UNPACKDIR_COMPAT}/10-add-data-ssh-keys-dir.conf -m 0644 ${D}${sysconfdir}/systemd/data-overlay-setup.service.d/
    install -d 0755 ${D}${sysconfdir}/systemd/sshdgenkeys.service.d
    install ${UNPACKDIR_COMPAT}/10-wait-for-data-overlay-setup.conf -m 0644 ${D}${sysconfdir}/systemd/sshdgenkeys.service.d/
}
